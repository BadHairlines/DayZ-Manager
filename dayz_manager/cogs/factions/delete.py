...
from dayz_manager.cogs.utils import database as db  # ✅ live shared db reference
...
class FactionDelete(commands.Cog):
    """Handles faction deletion and cleanup of roles, channels, and flags."""
