...
from dayz_manager.cogs.utils import database as db  # ✅ Use live database reference
...
class Assign(commands.Cog, BaseCog):
    ...
    async def assign(
        ...
        # ✅ Always reference db.db_pool (live connection)
        if db.db_pool is None:
            return await interaction.followup.send(
                "❌ Database not initialized. Please restart the bot.", ephemeral=True
            )
