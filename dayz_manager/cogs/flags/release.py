...
from dayz_manager.cogs.utils import database as db  # ✅ use live db reference
...
class Release(commands.Cog, BaseCog):
    ...
    async def release(
        ...
        # ✅ Always use the shared db connection
        if db.db_pool is None:
            return await interaction.followup.send(
                "❌ Database not initialized. Please restart the bot.",
                ephemeral=True,
            )
