...
from dayz_manager.cogs.utils import database as db  # ✅ live import (no stale db_pool)
...
class Setup(commands.Cog):
    ...
    async def setup(self, interaction: Interaction, selected_map: app_commands.Choice[str]):
        ...
        # ✅ Always check the live db connection
        ...
        try:
            ...
            # Create or fetch the flag channels
